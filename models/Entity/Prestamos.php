...
class Prestamos
{
     ...
     *
     * @Column(name="interes_adelantado", type="boolean", nullable=true)
     */
     ...
     *
     * @Column(name="capital_adelantado", type="boolean", nullable=true)
     */
    private $capitalAdelantado;

    /**
     * @var boolean $cuotaFija
     *
     * @Column(name="cuota_fija", type="boolean", nullable=true)
     */
    private $cuotaFija;
